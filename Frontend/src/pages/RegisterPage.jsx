...
function RegistrierungPage() {
    ...
    // Toggles für Passwörter
    const [showPassword, setShowPassword] = useState(false);
    const [showConfirmPassword, setShowConfirmPassword] = useState(false);

    // Popup für Anforderungen
    ...
    const passwordRequirements = [
        ...
        {
            label: "Mindestens 1 Großbuchstabe (A-Z)",
        ...
        {
            label: "Mindestens 1 Zahl (0-9)",
            valid: /\d/.test(password)
        },
        {
            label: "Mindestens 1 Sonderzeichen (!@#$%^&* usw.)",
            valid: /[!@#$%^&*(),.?":{}|<>]/.test(password)
        },
        {
    ...
    const emailRequirements = [
        ...
        {
            label: "Muss eine Domain enthalten (z.B. .de, .com, .ch)",
